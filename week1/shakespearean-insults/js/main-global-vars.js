...
//
// 1. Pick a random element from the first array (first adjectives)
...
const generateInsult = function(){
  ...
  const randomFirstAdjective = getRandomElementFromArray( firstAdjectives );
  const randomSecondAdjective = getRandomElementFromArray( secondAdjectives );
  const randomNoun = getRandomElementFromArray( nouns );

  return `Thou ${randomFirstAdjective} ${randomSecondAdjective} ${randomNoun}!`;
